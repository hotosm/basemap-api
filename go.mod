module github.com/hotosm/basemap-api
...
require (
	...
	github.com/protomaps/go-pmtiles v1.22.0
	github.com/tilezen/go-tilepacks v0.0.0-20240928014516-f75e8450bbe0
	gitlab.com/spwoodcock/mb2osm v0.1.0
